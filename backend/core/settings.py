"""
Django settings for the Ticket Management project.

All sensitive values are read from environment variables.
Use backend/.env (gitignored) for local development.

Required packages (see requirements.txt):
    python-decouple  — typed env-var reading
    psycopg2-binary  — PostgreSQL driver
    celery           — distributed task queue
    redis            — cache + Celery results backend
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "REST API for the Ticket Management application.",
    "VERSION": "1.0.0",
