...
{:else}
	<AppShell title="Profile" subtitle="Manage your personal details and workload.">
		<div class="overflow-hidden rounded-xl border border-surface-200 bg-white shadow-sm">
			<div class="h-20 bg-gradient-to-r from-surface-900 to-surface-800 sm:h-24"></div>
		...
		<div class="mt-4 grid gap-4 sm:mt-6 sm:gap-6 lg:grid-cols-[minmax(0,1.5fr)_minmax(320px,1fr)]">
			<div class="rounded-xl border border-surface-200 bg-white shadow-sm">
				...
				{#if assignedTickets.length === 0}
					<div class="px-4 py-10 text-center text-sm text-surface-400 sm:px-5 sm:py-12">
			...
			<div class="rounded-xl border border-surface-200 bg-white p-4 sm:p-6 shadow-sm">
				<div class="border-b border-surface-100 pb-3">
					<h2 class="text-sm font-semibold text-surface-900">Workload breakdown</h2>
				...
				<div class="mt-4">
					{#if assignedTotal > 0}
						...
						/>
					{:else}
						<div class="flex h-[200px] items-center justify-center text-sm text-surface-400">
				...
				<div class="mt-4 grid grid-cols-3 gap-2 text-center">
					<div class="rounded-lg bg-primary-50 p-2">
						<p class="text-lg font-bold text-primary-600">{assignedOpen}</p>
					...
					<div class="rounded-lg bg-emerald-50 p-2">
						...
						<p class="text-xs text-surface-500">Closed</p>
					</div>
				</div>
			</div>
		</div>
